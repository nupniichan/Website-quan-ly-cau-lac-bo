...
const ManageBudget = () => {
    ...
    const validateForm = () => {
        ...
        if (!newBudget.thanhVienChiuTrachNhiem?.trim()) {
            newErrors.thanhVienChiuTrachNhiem =
                "Vui lòng nhập thành viên chịu trách nhiệm";
        }
    ...
    return (
        <div className="flex flex-col gap-12 mt-12 mb-8">
            ...
            >
                ...
                <DialogBody
                    divider
                    className="grid grid-cols-2 gap-4 overflow-y-auto lg:max-h-[80vh] sm:max-h-[47vh]"
                >
                    <div>
                        <Input
                            label="Tên ngân sách"
