                ...
                {detailReport && (
                    <DialogBody divider className="grid grid-cols-2 gap-4 overflow-y-auto lg:max-h-[60vh] sm:max-h-[47vh]">
                        ...
                        <Typography>
                            ...
                            {formatDateForInput(detailReport.ngayBaoCao)}
                        </Typography>
                        <Typography>
                        ...
                        <ul className="col-span-2 pl-5 list-disc">
                            {detailReport.danhSachSuKien.map((event, index) => (
                                <li key={index}>
                                    ...
                                    {event.nguoiPhuTrach}, Ngày tổ chức:{" "}
                                    {formatDateForInput(event.ngayToChuc)})
                                </li>
                            ))}
                        </ul>
                        <Typography className="col-span-2">
                        ...
                        <ul className="col-span-2 pl-5 list-disc">
                            {detailReport.danhSachGiai.map((award, index) => (
                                <li key={index}>
                                    ...
                                    {award.nguoiNhanGiai}, Ngày nhận:{" "}
                                    {formatDateForInput(award.ngayNhanGiai)})
                                </li>
                            ))}
                        </ul>
                        <Typography>
                            <strong>Tổng ngân sách chi tiêu:</strong>{" "}
                            {detailReport.tongNganSachChiTieu.toLocaleString()}
                            {" "}
                            VND
                        </Typography>
                        <Typography>
