                                        ...
                                        <tbody>
                                            {currentEvents.map(({
                                                ...
                                                return (
                                                    <tr key={_id}>
                                                        <td
                                                            className={`${className} px-2 md:px-4`}
                                                        >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <Typography className="text-xs font-semibold text-blue-gray-600 truncate max-w-[200px]">
                                                                    {ten.length >
                                                                            30
                                                                        ? `${
                                                                            ten.substring(
                                                        ...
                                                        >
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                <Tooltip
                                                                    content={trangThai ===
                                                                            "daDuyet"
                                                                        ? "Không thể xóa sự kiện đã duyệt"
                                                                        : "Xóa"}
                                                                    animate={{
                                                                        mount: {
                                                                            scale:
